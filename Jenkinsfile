...
//       } 
      ...
      stage('terraform init') {
          steps{
//                bat 'terraform init -backend-config="access_key=ASIAZ3CUIHQKKSKWEULE" -backend-config="secret_key=+uZ7aGanMP7CzDLI+eZhD1yxgPVZiYADXNZpcxHv" -backend-config="session_token="'
                  bat 'terraform init'
          }
      }
